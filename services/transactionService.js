  ...
  upload(req, res, async (err) => {
    ...
    try {
      ...
      const entryData = {
        ...
        chasisProof: req.files && req.files['chasisProof'] ? getPdfUrl(req.files['chassisProof'][0].filename) : undefined,
        insuranceProof: req.files && req.files['insuranceProof'] ? getPdfUrl(req.files['insuranceProof'][0].filename) : undefined,
        pancardProof: req.files && req.files['pancardProof'] ? getPdfUrl(req.files['pancardProof'][0].filename) : undefined,
        addressProof: req.files && req.files['addressProof'] ? getPdfUrl(req.files['addressProof'][0].filename) : undefined,
      };
